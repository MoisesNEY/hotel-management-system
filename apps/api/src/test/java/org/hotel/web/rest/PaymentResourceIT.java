...
import static org.hotel.domain.PaymentAsserts.*;
...
import org.hotel.service.PaymentService;
...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().date(DEFAULT_DATE).amount(DEFAULT_AMOUNT).method(DEFAULT_METHOD).referenceId(DEFAULT_REFERENCE_ID);
        // Add required entity
        Invoice invoice;
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        ...
        updatedPayment.setInvoice(invoice);
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.date(UPDATED_DATE).amount(UPDATED_AMOUNT).method(UPDATED_METHOD).referenceId(UPDATED_REFERENCE_ID);
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.date(UPDATED_DATE).method(UPDATED_METHOD).referenceId(UPDATED_REFERENCE_ID);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.date(UPDATED_DATE).amount(UPDATED_AMOUNT).method(UPDATED_METHOD).referenceId(UPDATED_REFERENCE_ID);
