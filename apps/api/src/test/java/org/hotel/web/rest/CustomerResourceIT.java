...
import static org.hotel.domain.CustomerAsserts.*;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_PHONE = "+429333608";
    private static final String UPDATED_PHONE = "+241608352172";
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.addressLine1(UPDATED_ADDRESS_LINE_1).country(UPDATED_COUNTRY);
