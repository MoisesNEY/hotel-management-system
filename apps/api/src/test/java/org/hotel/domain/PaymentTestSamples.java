...
public class PaymentTestSamples {
    ...
    public static Payment getPaymentSample1() {
        return new Payment().id(1L).referenceId("referenceId1");
    }

    public static Payment getPaymentSample2() {
        return new Payment().id(2L).referenceId("referenceId2");
    }

    public static Payment getPaymentRandomSampleGenerator() {
        return new Payment().id(longCount.incrementAndGet()).referenceId(UUID.randomUUID().toString());
    }
}
