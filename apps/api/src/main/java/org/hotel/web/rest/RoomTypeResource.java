...
public class RoomTypeResource {
     ...
     *         body the new roomTypeDTO, or with status {@code 400 (Bad Request)} if
     *         the roomType has already an ID.
     ...
     *         the updated roomTypeDTO,
     *         or with status {@code 400 (Bad Request)} if the roomTypeDTO is not
     *         valid,
     *         or with status {@code 500 (Internal Server Error)} if the roomTypeDTO
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
    ...
    public ResponseEntity<RoomTypeDTO> updateRoomType(
            ...
            @Valid @RequestBody RoomTypeDTO roomTypeDTO) throws URISyntaxException {
    ...
    /**
     * {@code PATCH  /room-types/:id} : Partial updates given fields of an existing
     * roomType, field will ignore if it is null
     *
     * @param id          the id of the roomTypeDTO to save.
     * @param roomTypeDTO the roomTypeDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     ...
     *         or with status {@code 400 (Bad Request)} if the roomTypeDTO is not
     *         valid,
     *         or with status {@code 404 (Not Found)} if the roomTypeDTO is not
     *         found,
     *         or with status {@code 500 (Internal Server Error)} if the roomTypeDTO
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
    ...
    public ResponseEntity<RoomTypeDTO> partialUpdateRoomType(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody RoomTypeDTO roomTypeDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the roomTypeDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/{id}")
