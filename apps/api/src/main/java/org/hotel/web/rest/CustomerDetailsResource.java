...
/**
 * REST controller for managing {@link org.hotel.domain.CustomerDetails}.
 */
@RestController
@RequestMapping("/api/customer-details")
public class CustomerDetailsResource {

    private static final Logger LOG = LoggerFactory.getLogger(CustomerDetailsResource.class);

    private static final String ENTITY_NAME = "hotelBackendCustomerDetails";
